      ...
      <v-col cols="8">
        <v-form ref="formRef" lazy-validation class="ml-7" v-if="selectedRef && selectedRef.id != -1">
          <div class="d-inline-flex align-center">
            <v-text-field color="black" style="min-width: 100%" v-model="selectedRef.identifier"  :disabled="selectedRef.internalId !== 0" :rules="identifierRules" :label="$t('Config.Relations.Identifier')" required></v-text-field>
          ...
          <v-text-field color="black" v-model="selectedRef.order" type="number" :label="$t('Config.Relations.Order')" required></v-text-field>
