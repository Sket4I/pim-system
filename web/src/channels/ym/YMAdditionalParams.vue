      ...
      >
          ...
          <v-card>
            ...
            <v-card-text>
              <v-container>
                ...
                <v-row>
                  <v-autocomplete color="black" dense :readonly="readonly" v-model="editedItem.attrIdent" :items="pimAttributesRef" clearable label="Атрибут"></v-autocomplete>
                </v-row>
                <v-row
                  cols="12"
                  sm="6"
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="black" text @click="closeDelete">Отмена</v-btn>
