<template>
  <v-container style="background-color:white">
    <v-row no-gutters>
      <v-col cols="12">
        <v-select item-color="black" color="black" v-if="dashboardsSelection.length > 1" v-model="selectedRef" :items="dashboardsSelection" :label="$t('Dashboards.Select')"></v-select>
      </v-col>
