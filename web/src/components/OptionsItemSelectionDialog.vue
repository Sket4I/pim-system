      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <v-list dense class="pt-0 pb-0">
            <v-list-item-group v-model="itemSelectedRef" color="black">
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="black" text @click="closeDialog">{{ $t('OptionsTable.ItemSelectionsDialog.CloseButton.Text') }}</v-btn>
          <v-btn color="black" text @click="confirm">{{ $t('OptionsTable.ItemSelectionsDialog.CofirmButton.Text') }}</v-btn>
        </v-card-actions>
      </v-card>
