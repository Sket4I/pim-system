  ...
  <v-dialog v-model="dialogRef" persistent width="80%">
    <v-card>
            ...
            <v-col cols="6">
              <v-form ref="formRef" lazy-validation class="ml-7">
                <div class="d-inline-flex align-center">
                  <v-text-field color="black" style="min-width: 100%" v-model="selectedRef.identifier" :disabled="!creationRef" :error-messages="identifierErrors" :rules="identifierRules" :label="$t('SearchSaveDialog.Identifier')" required></v-text-field>
      ...
      <v-card-actions>
        ...
        <v-btn color="black" text @click="saveSearch">{{ $t('Save') }}</v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
