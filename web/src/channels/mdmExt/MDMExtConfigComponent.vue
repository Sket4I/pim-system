<template>
  <div>
    <v-text-field color="black" v-if="channel" v-model="channel.config.extCmd" :readonly=readonly :label="$t('Channels.Ext.cmd')" required></v-text-field>
    ...
    <v-row>
      <v-col cols="12">
        ...
        <v-btn color="black" v-if="!readonly" text @click="supplierCategorySelectionDialogRef.showDialog()">{{ $t('Select') }}</v-btn>
      </v-col>
    </v-row>
    ...
    <v-card class="mb-5 mt-5">
      ...
      <v-card-text>
        <v-divider></v-divider>
        <v-row>
          <v-col><v-text-field color="black" v-model="masterUrl" @change="masterUrlChanged" :label="$t('MappingConfigComponent.MasterHostUrl')" /></v-col>
        </v-row>
        <v-row class="pt-0 mt-0">
          <v-col><v-text-field color="black" v-model="masterLogin" @change="masterLoginChanged" :label="$t('MappingConfigComponent.MasterLogin')" dense/></v-col>
          <v-col><v-text-field color="black" v-model="masterPassword" @change="masterPasswordChanged" :label="$t('MappingConfigComponent.MasterPassword')" dense type="password" autocomplete="new-password"/></v-col>
        </v-row>
      </v-card-text>
    </v-card>
    ...
    <v-card class="mb-5 mt-5">
      ...
      <v-card-text>
        ...
        <v-row>
          <v-col>
            <v-text-field color="black" v-model="masterProductTypes" @change="masterProductTypesChanged" />
          </v-col>
        </v-row>
      </v-card-text>
    </v-card>
    ...
    <v-card class="mb-5 mt-5">
      ...
      <v-card-text>
        ...
        <v-row class="pt-0 mt-0">
          <v-col>
            <v-text-field color="black" v-model="masterCategoryAttributeIdentifier" @change="masterCategoryAttributeIdentifierChanged" dense :label="$t('MappingConfigComponent.MasterCategoryAttributeIdentifier')" />
          </v-col>
        </v-row>
      </v-card-text>
    </v-card>
    ...
    <v-row v-if="dataLoading">
      <v-col cols="12" style="text-align: center;"><v-progress-circular indeterminate color="black"></v-progress-circular></v-col>
    </v-row>
                ...
                <v-row>
                  <v-col cols="12">
                    <template v-if="categoriesTreeRef">
                      ...
                      <v-treeview color="black" class="scroll-body" dense hoverable activatable :items="categoriesTreeRef" :active.sync="treeActiveRef" :load-children="addChildren2TreeView"></v-treeview>
                    </template>
                  </v-col>
                </v-row>
              </v-container>
