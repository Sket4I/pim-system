<template>
    ...
    <v-col cols="12">
      ...
      <v-treeview color="black" dense activatable hoverable transition :items="itemsTree" :load-children="loadChildren" @update:active="activeChanged" :active.sync="activeRef" :open.sync="openRef">
